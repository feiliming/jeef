...
public class GeneratorDemo {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.dsideal.jeef.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getRootClassPath() + "/../../../src/com/dsideal/jeef/model/base";
		
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.dsideal.jeef.model";
		...
		gernerator.addExcludedTable("sys_organization");
